...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderHeader(user) {
        ...
        if (headerAvatar) {
            headerAvatar.src = avatarUrl(user?.avatarSeed || user?.username);
        }
    ...
    function renderProfileCard(user) {
        ...
        if (profileAvatar) {
            profileAvatar.src = avatarUrl(user?.avatarSeed || user?.username);
        }
    ...
    function prefillEditForm(user) {
        ...
        if (avatarSeedInput) {
            avatarSeedInput.value = user?.avatarSeed || "";
        }
    }
